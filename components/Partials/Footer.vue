    ...
    <footer class="bg-primary p-6 mt-24">
        <div class="flex justify-between">
            ...
            <div class="flex space-x-6 sm:justify-center sm:mt-0">
                <a href="https://twitter.com/CabAlex7" class="text-secondary hover:text-accent">
                ...
                <a href="https://github.com/CabAlexis" class="text-secondary hover:text-accent">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://www.linkedin.com/in/alexis-cabillic/" class="text-secondary hover:text-accent">
