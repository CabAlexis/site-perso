    ...
    <footer class="bg-primary p-6 mt-24">
        <div class="flex justify-between">
            ...
            <div class="flex space-x-6 sm:justify-center sm:mt-0">
                ...
                <a href="https://github.com/CabAlexis" class="text-secondary transition ease-in-out delay-50 hover:text-cyan-700 hover:-translate-y-1 hover:scale-150 duration-200">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://www.linkedin.com/in/alexis-cabillic/" class="text-secondary transition ease-in-out delay-50 hover:text-cyan-700 hover:-translate-y-1 hover:scale-150 duration-200">
