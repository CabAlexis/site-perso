    ...
    <div class="flex justify-between items-center w-9/12 md:w-full mx-auto md:mt-24">
      ...
      <div class="w-full ml-0 md:ml-24">
        ...
        <div class="flex flex-wrap">
          <div
            class="rounded-xl bg-secondary md:w-3/12 w-8/12 text-center m-2 flex justify-center items-center font-bold p-2">
            <div class="tooltip-box">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="fill-primary h-10 w-10 mr-2 stroke-2">
                <path
          ...
          <div
            class="rounded-xl bg-secondary md:w-3/12 w-8/12 text-center m-2 flex justify-center items-center font-bold p-2">
            <div class="tooltip-box">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="fill-primary h-10 w-10 mr-2 stroke-2">
                <path
          ...
          <div
            class="rounded-xl bg-secondary md:w-3/12 w-8/12 text-center m-2 flex justify-center items-center font-bold p-2">
            <div class="tooltip-box">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="fill-primary h-10 w-10 mr-2 stroke-2">
                <path
        ...
        <div class="flex flex-wrap">
          <div
            class="rounded-xl bg-secondary md:w-3/12 w-8/12 text-center m-2 flex justify-center items-center font-bold p-2">
            <div class="tooltip-box">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="fill-primary h-10 w-10 mr-2 stroke-2">
                <path
